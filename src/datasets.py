...
class CIRCODataset(Dataset):
    ...
    def __getitem__(self, index) -> dict:
        ...
        if self.mode == 'relative':
            ...
            blip2_caption_opt = self.annotations[index]['blip2_caption']
            gpt_caption =  self.annotations[index]['gpt-3.5-turbo']
            ...
            if self.split == 'val':
                ...
                return {
                    ...
                    'query_id': query_id,
                    'blip2_caption_opt': blip2_caption_opt,
                    'gpt_caption_opt': gpt_caption,
                    'gpt_caption_t5': gpt_caption_t5,
                    'gpt_caption_none': gpt_caption_none,
                    'multi_opt': multi_opt,
